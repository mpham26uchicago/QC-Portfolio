...
def CnX(n):
    """
    Build Optimized Relative Phase Multiple Controlled Toffoli
    ...
    --------
    circ: QuantumCircuit
        Optimized Relative Phase n-Toffoli
    """
...
def CnP(n, control_list = None, target = None, circ = None, theta = 1):
    ...
    Build Optimized Multiple Controlled Phase Circuit
    ...
    --------
    circ: QuantumCircuit
        Optimized Multiple Controlled Phase Circuit
...
def CnH(n, control_list=None, target=None, circ=None, theta=1):
        ...
        '''
    Build Optimized Multiple Controlled Hadamard Circuit
    ...
    --------
    circ: QuantumCircuit
        Optimized Multiple Controlled Hadamard Circuit
    '''
